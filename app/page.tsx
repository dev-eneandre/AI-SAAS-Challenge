...
const features = [
  ...
  },
  {
    ...
    description:
      "Engage with your PDFs like never before using our intuitive and interactive PDF viewer",
    icon: EyeIcon,
  },
  {
    name: "Cloud Backup",
  ...
  },
  {
    ...
    description:
      "Access and chat with your PDFs seamless on any device, whether it's your desktop, tablet or smartphone.",
